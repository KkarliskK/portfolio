...
function Footer() {
  ...
  return (
    <>
        <div className={`flex sm:flex-row flex-col bg-black w-full sm:h-1/5 h-3/5 shadow-lg justify-between `}> {/****This is the whole footer****/}
          <div className={`flex justify-center items-center h-full`}> <img className={`rounded-full sm:h-3/5 h-2/5 sm:ml-32`} src={logo} /> </div>{/****Logo****/}
          <div className={`flex justify-center flex-col items-center h-full`}>
            ...
            <div className={`flex justify-center`}> {/****Social media container****/}
